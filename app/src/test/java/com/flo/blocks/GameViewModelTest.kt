...
class GameViewModelTest {
        ...
        fun setup() {
                ...
                whenever(settingsRepository.achievementShowAroundTheCornerFlow)
                        .thenReturn(flowOf(true))
        ...
        fun `placeBrick triggers achievement message on multi-line clear`() =
                runTest(testDispatcher) {
                        ...
                        // Wait, rows clear 0..7. If (0,1) is part of the brick, it's cleared if
                        // line 1 is
                        // full.
                        // To NOT remove the whole brick, we need the brick to have a tile in a
                        // line/row
                        // that is NOT cleared.
                        ...
                        // This triggers Come and Gone because both tiles (0,0) and (0,1) are in
                        // cleared
                        // lines 0 and 1
        ...
        fun `placeBrick triggers random congrats when no achievements`() =
                runTest(testDispatcher) {
                        ...
                        // Second time: Random congrats (represented by no recording + no
                        // blockRemoved)
                        viewModel.game.value =
                                com.flo.blocks.game.GameState(
                                        board,
        ...
        fun `placeBrick triggers minimalist achievement for L-shape`() =
                runTest(testDispatcher) {
                        ...
                        val brick =
                                com.flo.blocks.game.rect(0, 0, 0, 2) +
                                        com.flo.blocks.game.rect(0, 2, 2, 2)
                        val coloredBrick =
                                com.flo.blocks.game.ColoredBrick(
                                        brick,
                                        com.flo.blocks.game.BlockColor.RED
                        ...
                        for (y in 0..7) if (y != 2)
                                board[0, y] = com.flo.blocks.game.BlockColor.BLUE
                        for (x in 0..7) if (x != 0)
                                board[x, 2] = com.flo.blocks.game.BlockColor.BLUE
